...
HMDA_cleaner(r'C:\Users\raywz\Coding\HMDA_year_2021.csv.', '2021 HMDA Full Clean')


# In[3]:


HMDA_cleaner([r'C:\Users\raywz\Coding\HMDA_year_2021.csv.'], 
             'HMDA Clean SAMPLE.csv')
